            ...
            HStack(spacing: ListRowTrailingSectionSpacing.horizontal) {
                ...
                Button {
                    ...
                    if showCopiedConfirmation {
                        CompoundIcon(\.check, size: .medium, relativeTo: .compound.bodyLG)
                            .foregroundStyle(.compound.iconSuccessPrimary)
                            .transition(.opacity)
                    } else {
                        CompoundIcon(\.copy, size: .medium, relativeTo: .compound.bodyLG)
...
public struct ListRow_Previews: PreviewProvider, TestablePreview {
    ...
    static var othersSection: some View {
        Section {
            ...
            ListRow(label: .plain(title: "User ID"),
                    kind: .copyableText(text: "@alice:example.com"))
        }
    }
}
