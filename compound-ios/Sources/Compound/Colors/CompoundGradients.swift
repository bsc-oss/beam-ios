...
public struct CompoundGradients {
    ...
    public var subtle: Gradient {
        .init(colors: [.compound.gradientSubtleStop1,
                       // PG_CHANGED: Matches gradientSubtleStop2, but for some reasons opacity is not correct when using the token directly.
                       Color(red: 218 / 255, green: 164 / 255, blue: 103 / 255, opacity: 0.23),
