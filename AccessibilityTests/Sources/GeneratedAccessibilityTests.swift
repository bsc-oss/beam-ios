...
extension AccessibilityTests {
    ...
    func testAuthenticationStartLogo() async throws {
        try await performAccessibilityAudit(named: "AuthenticationStartLogo_Previews")
    }
    ...
    func testPgEmailInputScreen() async throws {
        try await performAccessibilityAudit(named: "PgEmailInputScreen_Previews")
    }

    func testPgServiceMessageBanner() async throws {
        try await performAccessibilityAudit(named: "PgServiceMessageBanner_Previews")
    }

    func testPhoneBookConsentSelectionView() async throws {
        try await performAccessibilityAudit(named: "PhoneBookConsentSelectionView_Previews")
    }
