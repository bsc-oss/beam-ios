...
class AppLockSetupPINScreenViewModel: AppLockSetupPINScreenViewModelType, AppLockSetupPINScreenViewModelProtocol {
    ...
    // PG_CHANGED
    init(initialMode: AppLockSetupPINScreenMode, isLoadedFromOnboarding: Bool, appLockService: AppLockServiceProtocol) {
        self.appLockService = appLockService
        
        super.init(initialViewState: AppLockSetupPINScreenViewState(mode: initialMode,
                                                                    // PG_CHANGED
                                                                    isLoadedFromOnboarding: isLoadedFromOnboarding,
                                                                    deviceHasLockScreen: appLockService.deviceHasLockScreen,
                                                                    bindings: .init(pinCode: "")))
