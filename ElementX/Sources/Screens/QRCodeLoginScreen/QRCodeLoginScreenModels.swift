...
enum QRCodeLoginState: Equatable {
    ...
    enum ErrorState: Equatable, CaseIterable {
        ...
        case unknown
        /// PG_CHANGED: The user cancelled the system Web Authentication prompt/sheet.
...
struct QRCodeLoginScreenInstructions {
    ...
    // PG_CHANGED: steps for reciprocate QR login
    let loginItems = [
        AttributedString(L10n.pgScreenQrCodeLoginInitialStateItem1(InfoPlistReader.main.productionAppName)), // "Open { productionAppName } on web"
