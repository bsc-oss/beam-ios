...
struct QRCodeErrorView: View {
    ...
    var title: String {
        ...
        // PG_CHANGED: webAuthCancelled
        case .cancelled, .webAuthCancelled:
    ...
    var subtitle: String {
        ...
        case .webAuthCancelled:
            L10n.pgScreenQrCodeLoginErrorWebauthCancelledSubtitle
        }
    }
    ...
    private var buttons: some View {
        VStack(spacing: 16) {
            ...
            // PG_CHANGED - treats .webAuthCancelled the same as .cancelled, offering a retry option
            case .connectionNotSecure, .unknown, .expired, .declined, .slidingSyncNotAvailable, .cancelled, .webAuthCancelled:
...
private extension QRCodeLoginState.ErrorState {
    var previewDisplayName: String {
        ...
        case .webAuthCancelled: "WebAuth cancelled"
        }
    }
}
