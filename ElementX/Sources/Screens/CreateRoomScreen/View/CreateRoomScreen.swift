...
struct CreateRoom_Previews: PreviewProvider, TestablePreview {
    ...
    static let publicRoomViewModel = {
        // PG_CHANGED
        let viewModel = makeViewModel(publicRoomCreationEnabled: true)
    ...
    static let publicRoomExistingAliasViewModel = {
        // PG_CHANGED
        let viewModel = makeViewModel(isAliasAvailable: false, publicRoomCreationEnabled: true)
        viewModel.context.selectedAccessType = .public
    ...
    // PG_CHANGED
    static let restrictedViewModel = makeViewModel(userIDServerName: nil)
    ...
    static var previews: some View {
        ...
        // PG_CHANGED
        ElementNavigationStack {
            CreateRoomScreen(context: restrictedViewModel.context)
        }
        .previewDisplayName("Create Room, restricted settings")
    ...
    private static func makeViewModel(isKnockingEnabled: Bool = false,
                                      ...
                                      userIDServerName: String? = "example.org", // PG_CHANGED
                                      publicRoomCreationEnabled: Bool = false, // PG_CHANGED
                                      joinRoomByAddressEnabled: Bool = false // PG_CHANGED
        ...
        appSettings.joinRoomByAddressEnabled = joinRoomByAddressEnabled // PG_CHANGED
        
        let clientProxy = ClientProxyMock(.init(userIDServerName: userIDServerName,
