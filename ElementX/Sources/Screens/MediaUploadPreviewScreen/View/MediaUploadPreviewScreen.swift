...
struct MediaUploadPreviewScreen: View {
    ...
    var body: some View {
        mainContent
            ...
            // PG_CHANGED
            .sheet(item: $context.blockedFilesAlertInfo) { info in
                PgMediaUploadBlockedFilesSheetView(preferredColorScheme: colorSchemeOverride,
                                                   blockedFilenames: info.blockedFilenames,
