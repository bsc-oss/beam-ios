...
struct SecurityAndPrivacyScreen: View {
    ...
    private var roomAccessSection: some View {
        Section {
            // PG_CHANGED - conditionally show "Anyone" option based on publicRoomCreationEnabled flag
            if context.viewState.isPublicRoomCreationEnabled || context.viewState.currentSettings.accessType == .anyone {
