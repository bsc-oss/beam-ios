        ...
        TimelineViewRepresentable()
            ...
            .sheet(item: $timelineContext.actionMenuInfo) { info in
                let actions = TimelineItemMenuActionProvider(timelineItem: info.item,
                                                             ...
                                                             isCopyPermalinkEnabled: timelineContext.viewState.isCopyPermalinkEnabled,
                                                             // PG_CHANGED - allows report TimelineItemMenuAction only on dev builds
                                                             isReportEnabled: timelineContext.viewState.isReportEnabled,
                                                             // PG_CHANGED - puts translate TimelineItemMenuAction behind a feature flag (disabled by default)
                                                             isTranslateEnabled: timelineContext.viewState.isTranslateEnabled,
