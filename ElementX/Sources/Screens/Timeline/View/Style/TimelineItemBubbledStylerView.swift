        ...
        messageBubble
            ...
            .contextMenu {
                let provider = TimelineItemMenuActionProvider(timelineItem: timelineItem,
                                                              ...
                                                              isCopyPermalinkEnabled: context.viewState.isCopyPermalinkEnabled,
                                                              // PG_CHANGED - allows report TimelineItemMenuAction only on dev builds
                                                              isReportEnabled: context.viewState.isReportEnabled,
                                                              // PG_CHANGED - puts translate TimelineItemMenuAction behind a feature flag (disabled by default)
                                                              isTranslateEnabled: context.viewState.isTranslateEnabled,
