...
enum TimelineItemMenuAction: Identifiable, Hashable {
    ...
    var label: some View {
        ...
        case .translate:
            // TODO: fetch pg-compound-design-tokens upstream to get a translate icon
            // PG_CHANGED: using textFormatting icon as translate icon is not available in pg-compound-design-tokens
            Label(L10n.actionTranslate, icon: \.textFormatting)
        case .copyCaption:
