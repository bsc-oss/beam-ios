...
struct HomeScreenInviteCell: View {
    ...
    private var avatar: RoomAvatar {
        ...
        if room.isDirect, let inviter = room.inviter {
            // PG_CHANGED
            .heroes([.init(userID: inviter.id, displayName: inviter.displayName, avatarURL: hideInviteAvatars ? nil : inviter.avatarURL, email: inviter.email)])
        } else {
    ...
    private var subtitle: String? {
        // PG_CHANGED
        room.isDirect ? room.inviter?.emailOrId : nil
    }
...
struct HomeScreenInviteCell_Previews: PreviewProvider, TestablePreview {
    ...
    static func makeViewModel() -> HomeScreenViewModel {
        ...
        return HomeScreenViewModel(userSession: userSession,
                                   ...
                                   // PG_CHANGED
                                   pgServiceMessageService: PgServiceMessageService.mock(appSettings: AppSettings())) // PG_CHANGED - ServiceLocator removed upstream
    }
}
...
private extension HomeScreenRoom {
    static var dmInvite: HomeScreenRoom {
        ...
        // PG_CHANGED
        inviter.email = "someone@somewhere.com"
