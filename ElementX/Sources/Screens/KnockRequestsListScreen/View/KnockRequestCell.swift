...
// PG_CHANGED
struct KnockRequestCellInfo: Equatable, PgUserDescribing {
    let eventID: String
    let userID: String
...
struct KnockRequestCell: View {
    ...
    private var header: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            // PG_CHANGED
            if let secondaryInfo = cellInfo.secondaryInfo {
                Text(secondaryInfo)
...
struct KnockRequestCell_Previews: PreviewProvider, TestablePreview {
    ...
    static let aliceWithLongReason = KnockRequestCellInfo(eventID: "1", userID: "@alice:matrix.org", displayName: "Alice", email: "alice@matrix.org", avatarURL: nil, timestamp: "20 Nov 2024", reason: "Hello would like to join this room, also this is a very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very very long reason")
    
    // PG_CHANGED
    // swiftlint:disable:next line_length
    static let aliceWithShortReason = KnockRequestCellInfo(eventID: "1", userID: "@alice:matrix.org", displayName: "Alice", email: "alice@matrix.org", avatarURL: nil, timestamp: "20 Nov 2024", reason: "Hello, I am Alice and would like to join this room, please")
    
    static let aliceWithNoReason = KnockRequestCellInfo(eventID: "1", userID: "@alice:matrix.org", displayName: "Alice", email: "alice@matrix.org", avatarURL: nil, timestamp: "20 Nov 2024", reason: nil)
    
    static let aliceWithEmail = KnockRequestCellInfo(eventID: "1", userID: "@alice:matrix.org", displayName: nil, email: "alice@matrix.org", avatarURL: nil, timestamp: "20 Nov 2024", reason: nil)
    
    static let aliceWithNoName = KnockRequestCellInfo(eventID: "1", userID: "@alice:matrix.org", displayName: nil, email: nil, avatarURL: nil, timestamp: "20 Nov 2024", reason: nil)
    ...
    static var previews: some View {
        ...
        KnockRequestCell(cellInfo: aliceWithEmail) { _ in } onDecline: { _ in } onDeclineAndBan: { _ in }
            .previewDisplayName("With email")
