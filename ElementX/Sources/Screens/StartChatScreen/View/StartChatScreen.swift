...
struct StartChatScreen: View {
    ...
    private var mainContent: some View {
        createRoomSection
        // PG_CHANGED - upstream always shows this; PG gates it behind the RoomDirectorySearch flag
        if context.viewState.isRoomDirectorySearchEnabled {
            roomDirectorySearch
        }
        // PG_CHANGED
