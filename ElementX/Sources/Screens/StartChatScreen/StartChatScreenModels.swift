...
struct StartChatScreenViewState: BindableState {
    ...
    var isInviteFriendsEnabled = false
    // PG_CHANGED
    var isJoinRoomByAddressEnabled = false
    // PG_CHANGED - upstream always shows the directory entry; PG gates it behind the RoomDirectorySearch flag
