...
struct RoomScreenViewState: BindableState {
    ...
    var isUserAloneInRoom = true
    
    // PG_CHANGED - hide call button when user is alone in room
    var shouldShowCallButton: Bool {
        isCallingEnabled && !isParticipatingInOngoingCall && !isUserAloneInRoom // Hide the join call button when already in the call or alone in room
    }
