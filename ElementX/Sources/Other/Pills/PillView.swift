...
struct PillView: View {
    ...
    /// PG_CHANGED
    var textColor: Color {
        context.viewState.isOwnMention ? .compound.textMentionUser : .compound.textPrimary
    }
    
    /// PG_CHANGED
    var backgroundColor: Color {
        context.viewState.isOwnMention ? .compound.bgMentionUser : .compound.bgBadgeDefault
    }
