...
struct PillView: View {
    ...
    // PG_CHANGED
    var textColor: Color {
        // PG_CHANGED - branded own-mention color (textMentionUser); adopt upstream textOnSolidPrimary for others
        context.viewState.isOwnMention ? .compound.textMentionUser : .compound.textOnSolidPrimary
    }
    
    // PG_CHANGED
    var backgroundColor: Color {
        // PG_CHANGED - branded own-mention color (bgMentionUser); adopt upstream bgBadgePrimary for others
        context.viewState.isOwnMention ? .compound.bgMentionUser : .compound.bgBadgePrimary
    }
