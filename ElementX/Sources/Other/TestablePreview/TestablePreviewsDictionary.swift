...
enum TestablePreviewsDictionary {
    static let dictionary: [String: any PreviewProvider.Type] = [
        ...
        "AuthenticationStartLogo_Previews" : AuthenticationStartLogo_Previews.self,
        ...
        "PgEmailInputScreen_Previews" : PgEmailInputScreen_Previews.self,
        "PgServiceMessageBanner_Previews" : PgServiceMessageBanner_Previews.self,
        "PhoneBookConsentSelectionView_Previews" : PhoneBookConsentSelectionView_Previews.self,
