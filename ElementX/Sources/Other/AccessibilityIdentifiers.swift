...
enum A11yIdentifiers {
    ...
    static let pgEmailInputScreen = PgEmailInputScreen()
    ...
    struct SettingsScreen {
        ...
        // PG_CHANGED: added qrLogin
        let qrLogin = "settings_qr-login"
    ...
    // PG_CHANGED
    struct PgEmailInputScreen {
        let emailtextField = "pg_email_input-text_field"
        let continueButton = "pg_email_input-continue_button"
    }
