...
class AppLockServiceMock: AppLockServiceProtocol, @unchecked Sendable {
    ...
    var deviceHasLockScreen: Bool {
        get { return underlyingDeviceHasLockScreen }
        set(value) { underlyingDeviceHasLockScreen = value }
    }
    var underlyingDeviceHasLockScreen: Bool!
    var isEnabled: Bool {
...
class ClientProxyMock: ClientProxyProtocol, @unchecked Sendable {
    ...
    var userProfileProxyPublisher: CurrentValuePublisher<UserProfileProxy?, Never> {
        get { return underlyingUserProfileProxyPublisher }
        set(value) { underlyingUserProfileProxyPublisher = value }
    }
    var underlyingUserProfileProxyPublisher: CurrentValuePublisher<UserProfileProxy?, Never>!
    ...
    //MARK: - uploadArgusFile

    var uploadArgusFileFileNameFieldsUnderlyingCallsCount = 0
    var uploadArgusFileFileNameFieldsCallsCount: Int {
        get {
            if Thread.isMainThread {
                return uploadArgusFileFileNameFieldsUnderlyingCallsCount
            } else {
                var returnValue: Int? = nil
                DispatchQueue.main.sync {
                    returnValue = uploadArgusFileFileNameFieldsUnderlyingCallsCount
                }
        ...
        set {
            if Thread.isMainThread {
                uploadArgusFileFileNameFieldsUnderlyingCallsCount = newValue
            } else {
                DispatchQueue.main.sync {
                    uploadArgusFileFileNameFieldsUnderlyingCallsCount = newValue
                }
    ...
    var uploadArgusFileFileNameFieldsCalled: Bool {
        return uploadArgusFileFileNameFieldsCallsCount > 0
    }
    var uploadArgusFileFileNameFieldsReceivedArguments: (media: MediaInfo, fileName: String?, fields: [String: String])?
    var uploadArgusFileFileNameFieldsReceivedInvocations: [(media: MediaInfo, fileName: String?, fields: [String: String])] = []

    var uploadArgusFileFileNameFieldsUnderlyingReturnValue: Result<String, ClientProxyError>!
    var uploadArgusFileFileNameFieldsReturnValue: Result<String, ClientProxyError>! {
        get {
            if Thread.isMainThread {
                return uploadArgusFileFileNameFieldsUnderlyingReturnValue
            } else {
                var returnValue: Result<String, ClientProxyError>? = nil
                DispatchQueue.main.sync {
                    returnValue = uploadArgusFileFileNameFieldsUnderlyingReturnValue
                }
        ...
        set {
            if Thread.isMainThread {
                uploadArgusFileFileNameFieldsUnderlyingReturnValue = newValue
            } else {
                DispatchQueue.main.sync {
                    uploadArgusFileFileNameFieldsUnderlyingReturnValue = newValue
                }
    ...
    var uploadArgusFileFileNameFieldsClosure: ((MediaInfo, String?, [String: String]) async -> Result<String, ClientProxyError>)?

    func uploadArgusFile(_ media: MediaInfo, fileName: String?, fields: [String: String]) async -> Result<String, ClientProxyError> {
        uploadArgusFileFileNameFieldsCallsCount += 1
        uploadArgusFileFileNameFieldsReceivedArguments = (media: media, fileName: fileName, fields: fields)
        DispatchQueue.main.async {
            self.uploadArgusFileFileNameFieldsReceivedInvocations.append((media: media, fileName: fileName, fields: fields))
        }
        if let uploadArgusFileFileNameFieldsClosure = uploadArgusFileFileNameFieldsClosure {
            return await uploadArgusFileFileNameFieldsClosure(media, fileName, fields)
        } else {
            return uploadArgusFileFileNameFieldsReturnValue
        }
    }
    //MARK: - reportSighting

    var reportSightingUnderlyingCallsCount = 0
    var reportSightingCallsCount: Int {
        get {
            if Thread.isMainThread {
                return reportSightingUnderlyingCallsCount
            } else {
                var returnValue: Int? = nil
                DispatchQueue.main.sync {
                    returnValue = reportSightingUnderlyingCallsCount
                }
        ...
        set {
            if Thread.isMainThread {
                reportSightingUnderlyingCallsCount = newValue
            } else {
                DispatchQueue.main.sync {
                    reportSightingUnderlyingCallsCount = newValue
                }
    ...
    var reportSightingCalled: Bool {
        return reportSightingCallsCount > 0
    }
    var reportSightingReceivedRequest: CreateSightingRequest?
    var reportSightingReceivedInvocations: [CreateSightingRequest] = []

    var reportSightingUnderlyingReturnValue: Result<Void, ClientProxyError>!
    var reportSightingReturnValue: Result<Void, ClientProxyError>! {
        get {
            if Thread.isMainThread {
                return reportSightingUnderlyingReturnValue
            } else {
                var returnValue: Result<Void, ClientProxyError>? = nil
                DispatchQueue.main.sync {
                    returnValue = reportSightingUnderlyingReturnValue
                }
        ...
        set {
            if Thread.isMainThread {
                reportSightingUnderlyingReturnValue = newValue
            } else {
                DispatchQueue.main.sync {
                    reportSightingUnderlyingReturnValue = newValue
                }
    ...
    var reportSightingClosure: ((CreateSightingRequest) async -> Result<Void, ClientProxyError>)?

    func reportSighting(_ request: CreateSightingRequest) async -> Result<Void, ClientProxyError> {
        reportSightingCallsCount += 1
        reportSightingReceivedRequest = request
        DispatchQueue.main.async {
            self.reportSightingReceivedInvocations.append(request)
        }
        if let reportSightingClosure = reportSightingClosure {
            return await reportSightingClosure(request)
        } else {
            return reportSightingReturnValue
        }
    }
    ...
    //MARK: - loadUserProfileProxy

    var loadUserProfileProxyUnderlyingCallsCount = 0
    var loadUserProfileProxyCallsCount: Int {
        get {
            if Thread.isMainThread {
                return loadUserProfileProxyUnderlyingCallsCount
            } else {
                var returnValue: Int? = nil
                DispatchQueue.main.sync {
                    returnValue = loadUserProfileProxyUnderlyingCallsCount
                }
        ...
        set {
            if Thread.isMainThread {
                loadUserProfileProxyUnderlyingCallsCount = newValue
            } else {
                DispatchQueue.main.sync {
                    loadUserProfileProxyUnderlyingCallsCount = newValue
                }
    ...
    var loadUserProfileProxyCalled: Bool {
        return loadUserProfileProxyCallsCount > 0
    }

    var loadUserProfileProxyUnderlyingReturnValue: Result<Void, ClientProxyError>!
    var loadUserProfileProxyReturnValue: Result<Void, ClientProxyError>! {
        get {
            if Thread.isMainThread {
                return loadUserProfileProxyUnderlyingReturnValue
            } else {
                var returnValue: Result<Void, ClientProxyError>? = nil
                DispatchQueue.main.sync {
                    returnValue = loadUserProfileProxyUnderlyingReturnValue
                }
        ...
        set {
            if Thread.isMainThread {
                loadUserProfileProxyUnderlyingReturnValue = newValue
            } else {
                DispatchQueue.main.sync {
                    loadUserProfileProxyUnderlyingReturnValue = newValue
                }
    ...
    var loadUserProfileProxyClosure: (() async -> Result<Void, ClientProxyError>)?

    @discardableResult
    func loadUserProfileProxy() async -> Result<Void, ClientProxyError> {
        loadUserProfileProxyCallsCount += 1
        if let loadUserProfileProxyClosure = loadUserProfileProxyClosure {
            return await loadUserProfileProxyClosure()
        } else {
            return loadUserProfileProxyReturnValue
        }
    }
    ...
    //MARK: - setUserFunction

    var setUserFunctionUnderlyingCallsCount = 0
    var setUserFunctionCallsCount: Int {
        get {
            if Thread.isMainThread {
                return setUserFunctionUnderlyingCallsCount
            } else {
                var returnValue: Int? = nil
                DispatchQueue.main.sync {
                    returnValue = setUserFunctionUnderlyingCallsCount
                }
        ...
        set {
            if Thread.isMainThread {
                setUserFunctionUnderlyingCallsCount = newValue
            } else {
                DispatchQueue.main.sync {
                    setUserFunctionUnderlyingCallsCount = newValue
                }
    ...
    var setUserFunctionCalled: Bool {
        return setUserFunctionCallsCount > 0
    }
    var setUserFunctionReceivedFunction: String?
    var setUserFunctionReceivedInvocations: [String] = []

    var setUserFunctionUnderlyingReturnValue: Result<Void, ClientProxyError>!
    var setUserFunctionReturnValue: Result<Void, ClientProxyError>! {
        get {
            if Thread.isMainThread {
                return setUserFunctionUnderlyingReturnValue
            } else {
                var returnValue: Result<Void, ClientProxyError>? = nil
                DispatchQueue.main.sync {
                    returnValue = setUserFunctionUnderlyingReturnValue
                }
        ...
        set {
            if Thread.isMainThread {
                setUserFunctionUnderlyingReturnValue = newValue
            } else {
                DispatchQueue.main.sync {
                    setUserFunctionUnderlyingReturnValue = newValue
                }
    ...
    var setUserFunctionClosure: ((String) async -> Result<Void, ClientProxyError>)?

    func setUserFunction(_ function: String) async -> Result<Void, ClientProxyError> {
        setUserFunctionCallsCount += 1
        setUserFunctionReceivedFunction = function
        DispatchQueue.main.async {
            self.setUserFunctionReceivedInvocations.append(function)
        }
        if let setUserFunctionClosure = setUserFunctionClosure {
            return await setUserFunctionClosure(function)
        } else {
            return setUserFunctionReturnValue
        }
    }
    //MARK: - setPhoneBookConsentType

    var setPhoneBookConsentTypeUnderlyingCallsCount = 0
    var setPhoneBookConsentTypeCallsCount: Int {
        get {
            if Thread.isMainThread {
                return setPhoneBookConsentTypeUnderlyingCallsCount
            } else {
                var returnValue: Int? = nil
                DispatchQueue.main.sync {
                    returnValue = setPhoneBookConsentTypeUnderlyingCallsCount
                }
        ...
        set {
            if Thread.isMainThread {
                setPhoneBookConsentTypeUnderlyingCallsCount = newValue
            } else {
                DispatchQueue.main.sync {
                    setPhoneBookConsentTypeUnderlyingCallsCount = newValue
                }
    ...
    var setPhoneBookConsentTypeCalled: Bool {
        return setPhoneBookConsentTypeCallsCount > 0
    }
    var setPhoneBookConsentTypeReceivedType: PhoneBookConsentType?
    var setPhoneBookConsentTypeReceivedInvocations: [PhoneBookConsentType] = []

    var setPhoneBookConsentTypeUnderlyingReturnValue: Result<Void, ClientProxyError>!
    var setPhoneBookConsentTypeReturnValue: Result<Void, ClientProxyError>! {
        get {
            if Thread.isMainThread {
                return setPhoneBookConsentTypeUnderlyingReturnValue
            } else {
                var returnValue: Result<Void, ClientProxyError>? = nil
                DispatchQueue.main.sync {
                    returnValue = setPhoneBookConsentTypeUnderlyingReturnValue
                }
        ...
        set {
            if Thread.isMainThread {
                setPhoneBookConsentTypeUnderlyingReturnValue = newValue
            } else {
                DispatchQueue.main.sync {
                    setPhoneBookConsentTypeUnderlyingReturnValue = newValue
                }
    ...
    var setPhoneBookConsentTypeClosure: ((PhoneBookConsentType) async -> Result<Void, ClientProxyError>)?

    func setPhoneBookConsentType(_ type: PhoneBookConsentType) async -> Result<Void, ClientProxyError> {
        setPhoneBookConsentTypeCallsCount += 1
        setPhoneBookConsentTypeReceivedType = type
        DispatchQueue.main.async {
            self.setPhoneBookConsentTypeReceivedInvocations.append(type)
        }
        if let setPhoneBookConsentTypeClosure = setPhoneBookConsentTypeClosure {
            return await setPhoneBookConsentTypeClosure(type)
        } else {
            return setPhoneBookConsentTypeReturnValue
        }
    }
    //MARK: - setProfileInitialized

    var setProfileInitializedUnderlyingCallsCount = 0
    var setProfileInitializedCallsCount: Int {
        get {
            if Thread.isMainThread {
                return setProfileInitializedUnderlyingCallsCount
            } else {
                var returnValue: Int? = nil
                DispatchQueue.main.sync {
                    returnValue = setProfileInitializedUnderlyingCallsCount
                }
        ...
        set {
            if Thread.isMainThread {
                setProfileInitializedUnderlyingCallsCount = newValue
            } else {
                DispatchQueue.main.sync {
                    setProfileInitializedUnderlyingCallsCount = newValue
                }
    ...
    var setProfileInitializedCalled: Bool {
        return setProfileInitializedCallsCount > 0
    }
    var setProfileInitializedReceivedIsInitialized: Bool?
    var setProfileInitializedReceivedInvocations: [Bool] = []

    var setProfileInitializedUnderlyingReturnValue: Result<Void, ClientProxyError>!
    var setProfileInitializedReturnValue: Result<Void, ClientProxyError>! {
        get {
            if Thread.isMainThread {
                return setProfileInitializedUnderlyingReturnValue
            } else {
                var returnValue: Result<Void, ClientProxyError>? = nil
                DispatchQueue.main.sync {
                    returnValue = setProfileInitializedUnderlyingReturnValue
                }
        ...
        set {
            if Thread.isMainThread {
                setProfileInitializedUnderlyingReturnValue = newValue
            } else {
                DispatchQueue.main.sync {
                    setProfileInitializedUnderlyingReturnValue = newValue
                }
    ...
    var setProfileInitializedClosure: ((Bool) async -> Result<Void, ClientProxyError>)?

    func setProfileInitialized(_ isInitialized: Bool) async -> Result<Void, ClientProxyError> {
        setProfileInitializedCallsCount += 1
        setProfileInitializedReceivedIsInitialized = isInitialized
        DispatchQueue.main.async {
            self.setProfileInitializedReceivedInvocations.append(isInitialized)
        }
        if let setProfileInitializedClosure = setProfileInitializedClosure {
            return await setProfileInitializedClosure(isInitialized)
        } else {
            return setProfileInitializedReturnValue
        }
    }
    //MARK: - setUserAvatar
    ...
    //MARK: - reciprocateWithQrCode

    var reciprocateWithQrCodeQrCodeDataProgressListenerUnderlyingCallsCount = 0
    var reciprocateWithQrCodeQrCodeDataProgressListenerCallsCount: Int {
        get {
            if Thread.isMainThread {
                return reciprocateWithQrCodeQrCodeDataProgressListenerUnderlyingCallsCount
            } else {
                var returnValue: Int? = nil
                DispatchQueue.main.sync {
                    returnValue = reciprocateWithQrCodeQrCodeDataProgressListenerUnderlyingCallsCount
                }
        ...
        set {
            if Thread.isMainThread {
                reciprocateWithQrCodeQrCodeDataProgressListenerUnderlyingCallsCount = newValue
            } else {
                DispatchQueue.main.sync {
                    reciprocateWithQrCodeQrCodeDataProgressListenerUnderlyingCallsCount = newValue
                }
    ...
    var reciprocateWithQrCodeQrCodeDataProgressListenerCalled: Bool {
        return reciprocateWithQrCodeQrCodeDataProgressListenerCallsCount > 0
    }
    var reciprocateWithQrCodeQrCodeDataProgressListenerReceivedArguments: (qrCodeData: QrCodeData, progressListener: QrLoginProgressListener)?
    var reciprocateWithQrCodeQrCodeDataProgressListenerReceivedInvocations: [(qrCodeData: QrCodeData, progressListener: QrLoginProgressListener)] = []

    var reciprocateWithQrCodeQrCodeDataProgressListenerUnderlyingReturnValue: Result<Void, ClientProxyError>!
    var reciprocateWithQrCodeQrCodeDataProgressListenerReturnValue: Result<Void, ClientProxyError>! {
        get {
            if Thread.isMainThread {
                return reciprocateWithQrCodeQrCodeDataProgressListenerUnderlyingReturnValue
            } else {
                var returnValue: Result<Void, ClientProxyError>? = nil
                DispatchQueue.main.sync {
                    returnValue = reciprocateWithQrCodeQrCodeDataProgressListenerUnderlyingReturnValue
                }
        ...
        set {
            if Thread.isMainThread {
                reciprocateWithQrCodeQrCodeDataProgressListenerUnderlyingReturnValue = newValue
            } else {
                DispatchQueue.main.sync {
                    reciprocateWithQrCodeQrCodeDataProgressListenerUnderlyingReturnValue = newValue
                }
    ...
    var reciprocateWithQrCodeQrCodeDataProgressListenerClosure: ((QrCodeData, QrLoginProgressListener) async -> Result<Void, ClientProxyError>)?

    func reciprocateWithQrCode(qrCodeData: QrCodeData, progressListener: QrLoginProgressListener) async -> Result<Void, ClientProxyError> {
        reciprocateWithQrCodeQrCodeDataProgressListenerCallsCount += 1
        reciprocateWithQrCodeQrCodeDataProgressListenerReceivedArguments = (qrCodeData: qrCodeData, progressListener: progressListener)
        DispatchQueue.main.async {
            self.reciprocateWithQrCodeQrCodeDataProgressListenerReceivedInvocations.append((qrCodeData: qrCodeData, progressListener: progressListener))
        }
        if let reciprocateWithQrCodeQrCodeDataProgressListenerClosure = reciprocateWithQrCodeQrCodeDataProgressListenerClosure {
            return await reciprocateWithQrCodeQrCodeDataProgressListenerClosure(qrCodeData, progressListener)
        } else {
            return reciprocateWithQrCodeQrCodeDataProgressListenerReturnValue
        }
    }
    //MARK: - resumeQrReciprocation

    var resumeQrReciprocationUnderlyingCallsCount = 0
    var resumeQrReciprocationCallsCount: Int {
        get {
            if Thread.isMainThread {
                return resumeQrReciprocationUnderlyingCallsCount
            } else {
                var returnValue: Int? = nil
                DispatchQueue.main.sync {
                    returnValue = resumeQrReciprocationUnderlyingCallsCount
                }
        ...
        set {
            if Thread.isMainThread {
                resumeQrReciprocationUnderlyingCallsCount = newValue
            } else {
                DispatchQueue.main.sync {
                    resumeQrReciprocationUnderlyingCallsCount = newValue
                }
    ...
    var resumeQrReciprocationCalled: Bool {
        return resumeQrReciprocationCallsCount > 0
    }

    var resumeQrReciprocationUnderlyingReturnValue: Result<Void, ClientProxyError>!
    var resumeQrReciprocationReturnValue: Result<Void, ClientProxyError>! {
        get {
            if Thread.isMainThread {
                return resumeQrReciprocationUnderlyingReturnValue
            } else {
                var returnValue: Result<Void, ClientProxyError>? = nil
                DispatchQueue.main.sync {
                    returnValue = resumeQrReciprocationUnderlyingReturnValue
                }
        ...
        set {
            if Thread.isMainThread {
                resumeQrReciprocationUnderlyingReturnValue = newValue
            } else {
                DispatchQueue.main.sync {
                    resumeQrReciprocationUnderlyingReturnValue = newValue
                }
    ...
    var resumeQrReciprocationClosure: (() async -> Result<Void, ClientProxyError>)?

    func resumeQrReciprocation() async -> Result<Void, ClientProxyError> {
        resumeQrReciprocationCallsCount += 1
        if let resumeQrReciprocationClosure = resumeQrReciprocationClosure {
            return await resumeQrReciprocationClosure()
        } else {
            return resumeQrReciprocationReturnValue
        }
    }
}
...
class PgEmailValidationServiceMock: PgEmailValidationServiceProtocol, @unchecked Sendable {

    //MARK: - validateEmail

    var validateEmailEmailUnderlyingCallsCount = 0
    var validateEmailEmailCallsCount: Int {
        get {
            if Thread.isMainThread {
                return validateEmailEmailUnderlyingCallsCount
            } else {
                var returnValue: Int? = nil
                DispatchQueue.main.sync {
                    returnValue = validateEmailEmailUnderlyingCallsCount
                }
        ...
        set {
            if Thread.isMainThread {
                validateEmailEmailUnderlyingCallsCount = newValue
            } else {
                DispatchQueue.main.sync {
                    validateEmailEmailUnderlyingCallsCount = newValue
                }
    ...
    var validateEmailEmailCalled: Bool {
        return validateEmailEmailCallsCount > 0
    }
    var validateEmailEmailReceivedEmail: String?
    var validateEmailEmailReceivedInvocations: [String] = []

    var validateEmailEmailUnderlyingReturnValue: Result<PgEmailValidationResponse, PgEmailValidationError>!
    var validateEmailEmailReturnValue: Result<PgEmailValidationResponse, PgEmailValidationError>! {
        get {
            if Thread.isMainThread {
                return validateEmailEmailUnderlyingReturnValue
            } else {
                var returnValue: Result<PgEmailValidationResponse, PgEmailValidationError>? = nil
                DispatchQueue.main.sync {
                    returnValue = validateEmailEmailUnderlyingReturnValue
                }
        ...
        set {
            if Thread.isMainThread {
                validateEmailEmailUnderlyingReturnValue = newValue
            } else {
                DispatchQueue.main.sync {
                    validateEmailEmailUnderlyingReturnValue = newValue
                }
    ...
    var validateEmailEmailClosure: ((String) async -> Result<PgEmailValidationResponse, PgEmailValidationError>)?

    func validateEmail(email: String) async -> Result<PgEmailValidationResponse, PgEmailValidationError> {
        validateEmailEmailCallsCount += 1
        validateEmailEmailReceivedEmail = email
        DispatchQueue.main.async {
            self.validateEmailEmailReceivedInvocations.append(email)
        }
        if let validateEmailEmailClosure = validateEmailEmailClosure {
            return await validateEmailEmailClosure(email)
        } else {
            return validateEmailEmailReturnValue
        }
    }
}
class PgServiceMessageServiceMock: PgServiceMessageServiceProtocol, @unchecked Sendable {
    var currentMessagePublisher: CurrentValuePublisher<PgServiceMessageDisplay?, Never> {
        get { return underlyingCurrentMessagePublisher }
        set(value) { underlyingCurrentMessagePublisher = value }
    }
    var underlyingCurrentMessagePublisher: CurrentValuePublisher<PgServiceMessageDisplay?, Never>!
    ...
    var dismissMessageIDUnderlyingCallsCount = 0
    var dismissMessageIDCallsCount: Int {
        get {
            if Thread.isMainThread {
                return dismissMessageIDUnderlyingCallsCount
            } else {
                var returnValue: Int? = nil
                DispatchQueue.main.sync {
                    returnValue = dismissMessageIDUnderlyingCallsCount
                }
        ...
        set {
            if Thread.isMainThread {
                dismissMessageIDUnderlyingCallsCount = newValue
            } else {
                DispatchQueue.main.sync {
                    dismissMessageIDUnderlyingCallsCount = newValue
                }
    ...
    var dismissMessageIDCalled: Bool {
        return dismissMessageIDCallsCount > 0
    }
    var dismissMessageIDReceivedMessageID: Int?
    var dismissMessageIDReceivedInvocations: [Int] = []
    var dismissMessageIDClosure: ((Int) -> Void)?

    func dismiss(messageID: Int) {
        dismissMessageIDCallsCount += 1
        dismissMessageIDReceivedMessageID = messageID
        DispatchQueue.main.async {
            self.dismissMessageIDReceivedInvocations.append(messageID)
        }
        dismissMessageIDClosure?(messageID)
    }
}
...
class QRCodeLoginServiceMock: QRCodeLoginServiceProtocol, @unchecked Sendable {
    ...
    //MARK: - resumeReciprocation

    var resumeReciprocationUnderlyingCallsCount = 0
    var resumeReciprocationCallsCount: Int {
        get {
            if Thread.isMainThread {
                return resumeReciprocationUnderlyingCallsCount
            } else {
                var returnValue: Int? = nil
                DispatchQueue.main.sync {
                    returnValue = resumeReciprocationUnderlyingCallsCount
                }
        ...
        set {
            if Thread.isMainThread {
                resumeReciprocationUnderlyingCallsCount = newValue
            } else {
                DispatchQueue.main.sync {
                    resumeReciprocationUnderlyingCallsCount = newValue
                }
    ...
    var resumeReciprocationCalled: Bool {
        return resumeReciprocationCallsCount > 0
    }
    var resumeReciprocationClosure: (() async -> Void)?

    func resumeReciprocation() async {
        resumeReciprocationCallsCount += 1
        await resumeReciprocationClosure?()
    }
...
class RoomInfoProxyMock: RoomInfoProxyProtocol, @unchecked Sendable {
    ...
    var hasOtherJoinedMember: Bool {
        get { return underlyingHasOtherJoinedMember }
        set(value) { underlyingHasOtherJoinedMember = value }
    }
    var underlyingHasOtherJoinedMember: Bool!
