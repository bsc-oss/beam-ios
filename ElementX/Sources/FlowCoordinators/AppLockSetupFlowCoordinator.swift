...
class AppLockSetupFlowCoordinator: FlowCoordinatorProtocol {
    ...
    private func showCreatePIN() {
        // PG_CHANGED: Renamed from isMandatory to isLoadedFromOnboarding for clarity.
        // When loaded from onboarding, the user cannot cancel the PIN setup.
        let isLoadedFromOnboarding = presentingFlow == .onboarding
