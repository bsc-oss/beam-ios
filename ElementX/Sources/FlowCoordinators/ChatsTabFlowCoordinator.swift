...
class ChatsTabFlowCoordinator: FlowCoordinatorProtocol {
    ...
    private func presentHomeScreen() {
        let parameters = HomeScreenCoordinatorParameters(userSession: userSession,
                                                         ...
                                                         userIndicatorController: flowParameters.userIndicatorController,
                                                         // PG_CHANGED
                                                         pgServiceMessageService: flowParameters.pgServiceMessageService)
        ...
        coordinator.actions
            .sink { [weak self] action in
                ...
                case .presentSpace(let spaceRoomListProxy):
                    // PG_CHANGED
                    guard flowParameters.appSettings.spacesEnabled else {
                        MXLog.info("Spaces are disabled, ignoring space presentation")
                        break
                    }
    ...
    private func startRoomFlow(roomID: String,
        ...
        coordinator.actions.sink { [weak self] action in
            ...
            case .continueWithSpaceFlow(let spaceRoomListProxy):
                ...
                guard flowParameters.appSettings.spacesEnabled else {
                    MXLog.info("Spaces are disabled, ignoring space flow continuation")
                    break
                }
