        ...
        coordinator.actions
            .sink { [weak self] action in
                ...
                case .presentLocationPicker:
                    // PG_CHANGED - gate the live location option behind the liveLocationSharingEnabled flag (off by default, Developer Options only)
                    stateMachine.tryEvent(.presentMapNavigator(interactionMode: .picker(shouldShowLiveLocationOption: flowParameters.appSettings.liveLocationSharingEnabled)),
                                          userInfo: EventUserInfo(animated: animated, timelineController: timelineController))
