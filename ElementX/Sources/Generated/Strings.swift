...
internal enum L10n {
  ...
  /// Bluetooth audio devices are not supported in this iOS version. Please choose a different audio device.
  ...
  /// This Beam ID can't be found, so the invite might not be received.
  ...
  /// Chat history is visible to new members. %1$@
  ...
  /// Your homeserver needs to be upgraded to support Beam Authentication Service and account creation.
  ...
  /// This group ID already exists. Please try editing the group ID field or change the group name.
  ...
  /// Argus is no longer available
  internal static var pgArgusNoLongerAvailable: String { return L10n.tr("Localizable", "pg_argus_no_longer_available") }
  /// You are about to download or share this attachment. Due to end-to-end encryption, this file cannot be scanned for viruses or malware.
  /// 
  /// Only download files from senders you trust. If you are unsure about this file's origin, cancel this action.
  internal static var pgAttachmentWarningMessage: String { return L10n.tr("Localizable", "pg_attachment_warning_message") }
  /// Security Warning
  internal static var pgAttachmentWarningTitle: String { return L10n.tr("Localizable", "pg_attachment_warning_title") }
  /// The file %1$@ cannot be shared or downloaded because its file type %2$@ is blocked.
  internal static func pgDialogFileTypeBlockedMessage(_ p1: Any, _ p2: Any) -> String {
    return L10n.tr("Localizable", "pg_dialog_file_type_blocked_message", String(describing: p1), String(describing: p2))
  }
  /// Blocked File Type
  internal static var pgDialogFileTypeBlockedTitle: String { return L10n.tr("Localizable", "pg_dialog_file_type_blocked_title") }
  /// You're about to open:
  /// 
  /// %1$@
  /// 
  /// Do you want to continue?
  internal static func pgDialogOpenLinkMessage(_ p1: Any) -> String {
    return L10n.tr("Localizable", "pg_dialog_open_link_message", String(describing: p1))
  }
  /// Open link?
  internal static var pgDialogOpenLinkTitle: String { return L10n.tr("Localizable", "pg_dialog_open_link_title") }
  /// Email is not in a valid format
  internal static var pgEmailInputScreenEmailInputInvalidEmailFormatFooterMessage: String { return L10n.tr("Localizable", "pg_email_input_screen_email_input_invalid_email_format_footer_message") }
  /// Email
  internal static var pgEmailInputScreenEmailInputPlaceholder: String { return L10n.tr("Localizable", "pg_email_input_screen_email_input_placeholder") }
  /// Please provide your official government email address. Only valid government domains are allowed.
  internal static var pgEmailInputScreenSubtitle: String { return L10n.tr("Localizable", "pg_email_input_screen_subtitle") }
  /// terms and conditions
  internal static var pgEmailInputScreenTermsAndConditionsLinkText: String { return L10n.tr("Localizable", "pg_email_input_screen_terms_and_conditions_link_text") }
  /// I accept the
  internal static var pgEmailInputScreenTermsAndConditionsMessage: String { return L10n.tr("Localizable", "pg_email_input_screen_terms_and_conditions_message") }
  /// Enter your email
  internal static var pgEmailInputScreenTitle: String { return L10n.tr("Localizable", "pg_email_input_screen_title") }
  /// The email address you entered does not belong to a known domain.
  internal static var pgEmailInputScreenUnknownEmailDomainErrorMessage: String { return L10n.tr("Localizable", "pg_email_input_screen_unknown_email_domain_error_message") }
  /// Enable the option to translate messages in the chat. Warning: the text to translate might go through Apple servers.
  internal static var pgScreenAdvancedSettingsTranslateDescription: String { return L10n.tr("Localizable", "pg_screen_advanced_settings_translate_description") }
  /// You can remove this PIN if you set up a screen lock on your device.
  internal static var pgScreenAppLockSettingsPinMandatoryHint: String { return L10n.tr("Localizable", "pg_screen_app_lock_settings_pin_mandatory_hint") }
  /// Your device is missing a screen lock. To ensure your chats remain secure, you must set a PIN for %1$@.
  /// 
  /// Choose something memorable. If you forget this PIN, you will be logged out of the app.
  internal static func pgScreenAppLockSetupPinContextOnboarding(_ p1: Any) -> String {
    return L10n.tr("Localizable", "pg_screen_app_lock_setup_pin_context_onboarding", String(describing: p1))
  }
  /// Create profile
  internal static var pgScreenCreateProfileTitle: String { return L10n.tr("Localizable", "pg_screen_create_profile_title") }
  /// Department
  internal static var pgScreenEditProfileDepartment: String { return L10n.tr("Localizable", "pg_screen_edit_profile_department") }
  /// Role
  internal static var pgScreenEditProfileFunction: String { return L10n.tr("Localizable", "pg_screen_edit_profile_function") }
  /// Let people know what you do at %1$@.
  internal static func pgScreenEditProfileFunctionFooter(_ p1: Any) -> String {
    return L10n.tr("Localizable", "pg_screen_edit_profile_function_footer", String(describing: p1))
  }
  /// Your role
  internal static var pgScreenEditProfileFunctionPlaceholder: String { return L10n.tr("Localizable", "pg_screen_edit_profile_function_placeholder") }
  /// To facilitate collaboration, colleagues can look you up in the app. Choose below how much privacy you prefer. Your phone number is never visible to other users, regardless of your choice.
  internal static var pgScreenEditProfilePhonebookConsentDescription: String { return L10n.tr("Localizable", "pg_screen_edit_profile_phonebook_consent_description") }
  /// Disclaimer: Once you accept an invitation and join a conversation, your profile details (name, role, organization, email) are visible to conversation partners, regardless of the setting above.
  internal static var pgScreenEditProfilePhonebookConsentDisclaimer: String { return L10n.tr("Localizable", "pg_screen_edit_profile_phonebook_consent_disclaimer") }
  /// Anyone can find you by (part of) your name or email address.
  internal static var pgScreenEditProfilePhonebookConsentFullBullet1: String { return L10n.tr("Localizable", "pg_screen_edit_profile_phonebook_consent_full_bullet1") }
  /// Your basic profile (name, job title, and organization) is immediately visible in search results.
  internal static var pgScreenEditProfilePhonebookConsentFullBullet2: String { return L10n.tr("Localizable", "pg_screen_edit_profile_phonebook_consent_full_bullet2") }
  /// Suitable for most users.
  internal static var pgScreenEditProfilePhonebookConsentFullSubtitle: String { return L10n.tr("Localizable", "pg_screen_edit_profile_phonebook_consent_full_subtitle") }
  /// Public address book (recommended)
  internal static var pgScreenEditProfilePhonebookConsentFullTitle: String { return L10n.tr("Localizable", "pg_screen_edit_profile_phonebook_consent_full_title") }
  /// Only findable if someone enters your full email address.
  internal static var pgScreenEditProfilePhonebookConsentLimitedBullet1: String { return L10n.tr("Localizable", "pg_screen_edit_profile_phonebook_consent_limited_bullet1") }
  /// Your profile information is only visible after you accept an invitation.
  internal static var pgScreenEditProfilePhonebookConsentLimitedBullet2: String { return L10n.tr("Localizable", "pg_screen_edit_profile_phonebook_consent_limited_bullet2") }
  /// You do not appear in a list, but you are findable.
  internal static var pgScreenEditProfilePhonebookConsentLimitedSubtitle: String { return L10n.tr("Localizable", "pg_screen_edit_profile_phonebook_consent_limited_subtitle") }
  /// Discreet - findable via email
  internal static var pgScreenEditProfilePhonebookConsentLimitedTitle: String { return L10n.tr("Localizable", "pg_screen_edit_profile_phonebook_consent_limited_title") }
  /// This makes it harder for colleagues to contact you.
  internal static var pgScreenEditProfilePhonebookConsentLimitedWarning: String { return L10n.tr("Localizable", "pg_screen_edit_profile_phonebook_consent_limited_warning") }
  /// You are only findable via BeamID. Suitable for strict privacy needs.
  internal static var pgScreenEditProfilePhonebookConsentNoneBullet1: String { return L10n.tr("Localizable", "pg_screen_edit_profile_phonebook_consent_none_bullet1") }
  /// Contact is only possible if someone manually enters your unique BeamID.
  internal static var pgScreenEditProfilePhonebookConsentNoneBullet2: String { return L10n.tr("Localizable", "pg_screen_edit_profile_phonebook_consent_none_bullet2") }
  /// For strict privacy needs.
  internal static var pgScreenEditProfilePhonebookConsentNoneSubtitle: String { return L10n.tr("Localizable", "pg_screen_edit_profile_phonebook_consent_none_subtitle") }
  /// Hidden - findable via BeamID
  internal static var pgScreenEditProfilePhonebookConsentNoneTitle: String { return L10n.tr("Localizable", "pg_screen_edit_profile_phonebook_consent_none_title") }
  /// You are practically unfindable. Use this only if strictly necessary.
  internal static var pgScreenEditProfilePhonebookConsentNoneWarning: String { return L10n.tr("Localizable", "pg_screen_edit_profile_phonebook_consent_none_warning") }
  /// How do you want to be found?
  internal static var pgScreenEditProfilePhonebookConsentTitle: String { return L10n.tr("Localizable", "pg_screen_edit_profile_phonebook_consent_title") }
  /// User ID
  internal static var pgScreenEditProfileUserID: String { return L10n.tr("Localizable", "pg_screen_edit_profile_userID") }
  /// Sign in
  internal static var pgScreenOnboardingSignInManually: String { return L10n.tr("Localizable", "pg_screen_onboarding_sign_in_manually") }
  /// Login with QR code
  internal static var pgScreenOnboardingSignInWithQrCode: String { return L10n.tr("Localizable", "pg_screen_onboarding_sign_in_with_qr_code") }
  /// Official Secure communication app for Belgian government personnel.
  internal static var pgScreenOnboardingWelcomeMessage: String { return L10n.tr("Localizable", "pg_screen_onboarding_welcome_message") }
  /// Welcome to
  internal static var pgScreenOnboardingWelcomeTitle: String { return L10n.tr("Localizable", "pg_screen_onboarding_welcome_title") }
  /// Beam
  internal static var pgScreenOnboardingWelcomeTitle2: String { return L10n.tr("Localizable", "pg_screen_onboarding_welcome_title2") }
  /// The system authentication prompt was cancelled.
  internal static var pgScreenQrCodeLoginErrorWebauthCancelledSubtitle: String { return L10n.tr("Localizable", "pg_screen_qr_code_login_error_webauth_cancelled_subtitle") }
  /// Open %1$@ on web
  internal static func pgScreenQrCodeLoginInitialStateItem1(_ p1: Any) -> String {
    return L10n.tr("Localizable", "pg_screen_qr_code_login_initial_state_item_1", String(describing: p1))
  }
  /// Link a device
  internal static var pgScreenSettingQrLogin: String { return L10n.tr("Localizable", "pg_screen_setting_qr_login") }
  /// Plural format key: "%#@COUNT@"
  internal static func pgUploadDialogFileBlockedMessage(_ p1: Int) -> String {
    return L10n.tr("Localizable", "pg_upload_dialog_file_blocked_message", p1)
  }
  ...
  /// Set a custom base URL for Beam Call.
  ...
  /// Hide group icons in invitation requests
  ...
  /// Enable the option to view message source in the chat.
  ...
  /// 
  /// Choose something memorable, as forgetting this PIN will log you out of the app.
  ...
  /// If they leave, they cannot rejoin this group, even if invited.
  ...
  /// They won’t be able to join this community again if invited, but they’ll still keep their memberships of any groups or subcommunities.
  ...
  /// They will be able to join this community again if invited, and they’ll still keep their memberships of any groups or subcomunities
  ...
  /// They would be able to join the group again if invited
  ...
  /// If you're having issues with notifications, uploading the settings can help us identify the problem.
  ...
  /// This feature is not available. You can provide feedback via support@beam.belgium.be.
  ...
  /// Beam is required on %1$@. Please download it from the store.
  ...
  /// Only invited people can access this group. All messages are end-to-end encrypted.
  ...
  /// Anyone can ask to join the group, but an administrator or a moderator will have to accept the request.
  ...
  /// In order for this group to be visible in the public group list, you will need a group ID.
  ...
  /// You need to set a group ID to make it visible in the group list.
  ...
  /// Now you can read or send messages securely.
  ...
  /// Are you sure you want to decline the invite to join this group? This will also prevent %1$@ from contacting you or inviting you to other groups.
  ...
  /// You may need to be invited or be a member of a community to join.
  ...
  /// %1$@ does not support communities yet. You can access communities on web.
  ...
  /// Are you sure you want to decline %1$@'s request to join this group?
  ...
  /// When someone requests to join the group, you’ll see their request appear here.
  ...
  /// Try out our latest ideas in development. These features are not finalized; they may be unstable and may change.
  ...
  /// You need to assign another admin for this community before you can leave.
  ...
  /// You will not be removed from this group because you're the only administrator:
  ...
  /// This login method is not supported. Please contact support@beam.belgium.be
  ...
  /// Beam uses Matrix for secure, decentralised communication.
  ...
  /// Other communities you’re not a member of
  ...
  /// Your homeserver doesn't support this option in encrypted groups; in some groups you might not get notifications.
  ...
  /// Sign in was not completed in time
  ...
  /// Scan the QR code shown on your browser
  ...
  /// Your report was submitted, but we encountered an issue leaving the group. Please try again.
  ...
  /// You can withdraw your verification and send this message, or cancel for now and try again later after re-verifying %1$@.
  ...
  /// This action cannot be undone. You are granting this user name the same permissions as you.
  ...
  /// You will not be able to undo this action. You are transferring ownership rights to the selected users. Once you leave the group, this will be permanent.
  ...
  /// There are no banned users in this group.
  ...
  /// Unsupported call. Ask if the caller can use the latest Beam version.
  ...
  /// Anyone in the authorized community can join, but access must be requested.
  ...
  /// Anyone can ask to join the group but an administrator or moderator will have to accept the request.
  ...
  /// Once enabled, encryption for a group cannot be disabled. Message history will only be visible to group members from the time they were invited or joined the group.
  /// No one outside the group members will be able to read the messages, which may prevent bots and bridges from functioning correctly.
  ...
  /// Choose which community members can join this group without an invitation. %1$@
  ...
  /// You’ll need a group ID in order to make it visible in the public group list.
  ...
  /// Allow for this group to be found by searching the %1$@ public group list.
  ...
  /// Allow to be found by searching the public group list.
  ...
  /// Who can read the group history?
  ...
  /// Only members can join since this option was selected.
  ...
  /// Group IDs help you find and access groups, making it easy to share with others. You can also publish your group in the public group list on your homeserver.
  ...
  /// IDs are a way to find and access groups and communities. This also ensures you can easily share them with others.
  ...
  /// A private server for Beam employees.
  ...
  /// Beam is a network for secure, decentralised communication
  ...
  /// Adding a group will not affect the group access. To change the access go to Group info > Privacy & security.
  ...
  /// Create communities to organize groups
  ...
  /// e.g. #group-name:homeservernumber.beam.belgium.be
  ...
  /// You changed the groupname to: %1$@
  ...
  /// Run tests to detect configuration issues
