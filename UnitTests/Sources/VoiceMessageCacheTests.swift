...
// PG_CHANGED: Added .serialized to prevent test isolation issues — the deinit (non-isolated in Swift 6)
// can race with other instances' @MainActor methods when tests run in parallel, deleting shared filesystem paths.
@Suite(.serialized)
@MainActor
