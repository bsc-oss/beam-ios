...
final class AppLockSetupPINScreenViewModelTests {
    ...
    // PG_CHANGED: use isLoadedFromOnboarding instead of isMandatory
    private func setup(mode: AppLockSetupPINScreenMode) {
        ...
        viewModel = AppLockSetupPINScreenViewModel(initialMode: mode, isLoadedFromOnboarding: false, appLockService: appLockService)
    }
}
