...
class AppLockSetupPINScreenViewModelTests: XCTestCase {
    ...
    func testCreatePIN() async throws {
        ...
        viewModel = AppLockSetupPINScreenViewModel(initialMode: .create, isLoadedFromOnboarding: false, appLockService: appLockService)
    ...
    func testUnlock() async throws {
        ...
        // PG_CHANGED
        viewModel = AppLockSetupPINScreenViewModel(initialMode: .unlock, isLoadedFromOnboarding: false, appLockService: appLockService)
        let pinCode = "2023"
