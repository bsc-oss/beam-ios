...
class CreateRoomScreenViewModelTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        ServiceLocator.shared.settings.publicRoomCreationEnabled = true // PG_CHANGED
    ...
    // PG_CHANGED
    func testPublicRoomCreationDisabledRemovesPublicAccessType() {
        // The setUp enables publicRoomCreationEnabled, so public should be available
        XCTAssertTrue(context.viewState.availableAccessTypes.contains(.public))
        ...
        XCTAssertFalse(vm.context.viewState.availableAccessTypes.contains(.public))
        XCTAssertTrue(vm.context.viewState.availableAccessTypes.contains(.private))
    }
