...
class RoomScreenViewModelTests: XCTestCase {
    ...
    func testCallButtonHiddenWhenUserIsAloneInRoom() async throws {
        ...
        XCTAssertTrue(viewModel.state.isUserAloneInRoom)
        XCTAssertFalse(viewModel.state.shouldShowCallButton)
    }
    
    func testCallButtonShownWhenUserIsNotAloneInRoom() async throws {
        ...
        XCTAssertFalse(viewModel.state.isUserAloneInRoom)
        XCTAssertTrue(viewModel.state.shouldShowCallButton)
    }
    
    func testCallButtonVisibilityUpdatesWhenMembersChange() async throws {
