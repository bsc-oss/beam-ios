...
class PhoneBookConsentTypeTests: XCTestCase {
    ...
    func testWarningTextForLimitedIsNotNil() {
        XCTAssertNotNil(PhoneBookConsentType.limited.warningText)
        XCTAssertFalse(PhoneBookConsentType.limited.warningText!.isEmpty)
    }
    
    func testWarningTextForNoneIsNotNil() {
        XCTAssertNotNil(PhoneBookConsentType.none.warningText)
        XCTAssertFalse(PhoneBookConsentType.none.warningText!.isEmpty)
    }
