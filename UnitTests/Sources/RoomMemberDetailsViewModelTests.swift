...
struct RoomMemberDetailsViewModelTests {
    ...
    // PG_CHANGED
    @Test
    mutating func createDirectChatSuccess() async throws {
        ...
        #expect(clientProxy.createDirectRoomWithExpectedRoomNameReceivedArguments?.userID == roomMemberProxyMock.userID)
        #expect(clientProxy.createDirectRoomWithExpectedRoomNameReceivedArguments?.expectedRoomName == roomMemberProxyMock.displayName)
    }
}
