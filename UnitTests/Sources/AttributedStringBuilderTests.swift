...
// PG_CHANGED: Updated tests to handle external link confirmation URL transformation
...
/// Helper to extract the effective URL from links that may be transformed for external link confirmation.
/// External links are transformed to `confirmexternal://` URLs containing the original URL as a parameter.
private extension URL {
    var effectiveURL: URL {
        externalLinkParameters?.originalURL ?? self
    }
}
...
class AttributedStringBuilderTests: XCTestCase {
    ...
    func testRenderHTMLStringWithLink() {
        ...
        XCTAssertEqual(link?.effectiveURL.host, "www.alpha.org")
    }
    ...
    func testRenderPlainStringWithLink() {
        ...
        XCTAssertEqual(link?.effectiveURL.host, "www.matrix.org")
    }
    ...
    func testPunctuationAtTheEndOfPlainStringLinks() {
        ...
        XCTAssertEqual(firstLink?.effectiveURL.absoluteString, "https://www.matrix.org")
        let secondLink = attributedString.runs.last { $0.link != nil }?.link
        XCTAssertEqual(secondLink?.effectiveURL.absoluteString, "https://example.com/(test)")
    }
    ...
    func testLinkDefaultScheme() {
        ...
        XCTAssertEqual(link?.effectiveURL.absoluteString, "https://matrix.org")
    }
    ...
    func testMailToLinks() {
        ...
        let link = attributedString.runs.first { $0.link != nil }?.link
        XCTAssertEqual(link?.effectiveURL.absoluteString, "mailto:stefan@matrix.org")
    }
    ...
    func testRenderHTMLStringWithLinkInHeader() {
        ...
        XCTAssertEqual(h1AttributedString.runs.first?.link?.effectiveURL.host, "matrix.org")
        XCTAssertEqual(h2AttributedString.runs.first?.link?.effectiveURL.host, "matrix.org")
        XCTAssertEqual(h3AttributedString.runs.first?.link?.effectiveURL.host, "matrix.org")
    }
    ...
    func testPermalink() {
        let string = "https://share.beam.belgium.be/#/!hello:matrix.org/$world?via=matrix.org"
    ...
    func testUserIDLink() {
        ...
        let expectedLink = "https://share.beam.belgium.be/#/\(userID)"
    ...
    func testRoomAliasLink() {
        ...
        guard let expectedLink = URL(string: "https://share.beam.belgium.be/#/\(roomAlias)") else {
    ...
    func testCustomForegroundColor() {
        ...
        for run in attributedString.runs {
            if run.link != nil {
                XCTAssertEqual(run.link?.effectiveURL.host, "www.matrix.org")
                XCTAssertNil(run.uiKit.foregroundColor)
                foundLink = true
            } else {
                XCTAssertNil(run.uiKit.foregroundColor)
    ...
    func testReplyBlockquote() {
        let htmlString = "<blockquote><a href=\"https://share.beam.belgium.be/#/someroom/someevent\">In reply to</a> <a href=\"https://share.beam.belgium.be/#/@user:matrix.org\">@user:matrix.org</a><br>The future is <code>swift run tools</code> 😎</blockquote>"
    ...
    func testUserPermalinkMentionAtachment() {
        let string = "https://share.beam.belgium.be/#/@test:matrix.org"
    ...
    func testUserIDMentionAtachment() {
        ...
        XCTAssertNotNil(attributedStringFromHTML?.attachment)
        XCTAssertEqual(attributedStringFromHTML?.userID, "@test:matrix.org")
        XCTAssertEqual(attributedStringFromHTML?.link?.absoluteString, "https://share.beam.belgium.be/#/@test:matrix.org")
        let attributedStringFromPlain = attributedStringBuilder.fromPlain(string)
        XCTAssertNotNil(attributedStringFromPlain?.attachment)
        XCTAssertEqual(attributedStringFromPlain?.userID, "@test:matrix.org")
        XCTAssertEqual(attributedStringFromPlain?.link?.absoluteString, "https://share.beam.belgium.be/#/@test:matrix.org")
    }
    ...
    func testRoomAliasPermalinkMentionAttachment() {
        ...
        XCTAssertEqual(attributedStringFromHTML?.link?.absoluteString, "https://share.beam.belgium.be/#/%23test:matrix.org")
        let attributedStringFromPlain = attributedStringBuilder.fromPlain(string)
        XCTAssertNotNil(attributedStringFromPlain?.attachment)
        XCTAssertEqual(attributedStringFromHTML?.roomAlias, "#test:matrix.org")
        XCTAssertEqual(attributedStringFromPlain?.link?.absoluteString, "https://share.beam.belgium.be/#/%23test:matrix.org")
    }
    ...
    func testEventRoomIDPermalinkMentionAttachment() {
        let string = "https://share.beam.belgium.be/#/!test:matrix.org/$test"
        let attributedStringFromHTML = attributedStringBuilder.fromHTML(string)
        XCTAssertNotNil(attributedStringFromHTML?.attachment)
    ...
    func testEventRoomAliasPermalinkMentionAttachment() {
        ...
        XCTAssertEqual(attributedStringFromHTML?.link?.absoluteString, "https://share.beam.belgium.be/#/%23test:matrix.org/$test")
        let attributedStringFromPlain = attributedStringBuilder.fromPlain(string)
        XCTAssertNotNil(attributedStringFromPlain?.attachment)
        XCTAssertEqual(attributedStringFromPlain?.eventOnRoomAlias, .some(.init(alias: "#test:matrix.org", eventID: "$test")))
        XCTAssertEqual(attributedStringFromPlain?.link?.absoluteString, "https://share.beam.belgium.be/#/%23test:matrix.org/$test")
    }
    
    func testUserMentionAtachmentInBlockQuotes() {
        let link = "https://share.beam.belgium.be/#/@test:matrix.org"
    ...
    func testLinksHavePriorityOverAllUserMention() {
        ...
        let string2 = "https://share.beam.belgium.be/#/@roomusername:matrix.org"
        let attributedStringFromHTML2 = attributedStringBuilder.fromHTML(string2)
    ...
    func testMultipleMentions() {
        guard let url = URL(string: "https://share.beam.belgium.be/#/@test:matrix.org") else {
            XCTFail("Invalid url")
            return
        }
    ...
    func testValidLink() {
        ...
        XCTAssertTrue(link.requiresExternalLinkConfirmation)
        XCTAssertEqual(link.effectiveURL.absoluteString, "https://matrix.org")
    }
    ...
    func testValidUserIDLink() {
        let htmlString = "Hey check the following user <a href=\"https://share.beam.belgium.be/#/@alice:matrix.org\">@alice:matrix.org</a>"
        ...
        XCTAssertFalse(link.requiresConfirmation)
        XCTAssertEqual(link.absoluteString, "https://share.beam.belgium.be/#/@alice:matrix.org")
    }
    
    func testPhishingUserIDWithAnotherUserIDPermalink() {
        let htmlString = "Hey check the following user <a href=\"https://share.beam.belgium.be/#/@bob:matrix.org\">@alice:matrix.org</a>"
        ...
        XCTAssertTrue(link.requiresConfirmation)
        XCTAssertEqual(link.confirmationParameters?.internalURL.absoluteString, "https://share.beam.belgium.be/#/@bob:matrix.org")
        XCTAssertEqual(link.confirmationParameters?.displayString, "@alice:matrix.org")
    }
    ...
    func testValidLinkWithDistractingCharacters() {
        ...
        XCTAssertFalse(link.requiresConfirmation)
        XCTAssertTrue(link.requiresExternalLinkConfirmation)
        XCTAssertEqual(link.effectiveURL.absoluteString, "https://element.io")
    }
    ...
    func testPhishingMatrixPermalinks() {
        let htmlString = "Hey check the following room <a href=\"https://share.beam.belgium.be/#/#offensive-room:matrix.org\">https://share.beam.belgium.be/#/#beautiful-room:matrix.org</a>"
        ...
        XCTAssertTrue(link.requiresConfirmation)
        XCTAssertEqual(link.confirmationParameters?.internalURL.absoluteString, "https://share.beam.belgium.be/#/%23offensive-room:matrix.org")
        XCTAssertEqual(link.confirmationParameters?.displayString, "https://share.beam.belgium.be/#/#beautiful-room:matrix.org")
    }
    
    func testValidMatrixPermalinks() {
        let htmlString = "Hey check the following room <a href=\"https://share.beam.belgium.be/#/#beautiful-room:matrix.org\">https://share.beam.belgium.be/#/#beautiful-room:matrix.org</a>"
        ...
        XCTAssertFalse(link.requiresConfirmation)
        XCTAssertEqual(link.absoluteString, "https://share.beam.belgium.be/#/%23beautiful-room:matrix.org")
    }
    ...
    func testValidRoomAliasLink() {
        let htmlString = "Hey check the following user <a href=\"https://share.beam.belgium.be/#/#room:matrix.org\">#room:matrix.org</a>"
        ...
        XCTAssertFalse(link.requiresConfirmation)
        XCTAssertEqual(link.absoluteString, "https://share.beam.belgium.be/#/%23room:matrix.org")
    }
    
    func testPhishingRoomAliasWithAnotherRoomAliasPermalink() {
        let htmlString = "Hey check the following room <a href=\"https://share.beam.belgium.be/#/#another-room:matrix.org\">#room:matrix.org</a>"
        ...
        XCTAssertTrue(link.requiresConfirmation)
        XCTAssertEqual(link.confirmationParameters?.internalURL.absoluteString, "https://share.beam.belgium.be/#/%23another-room:matrix.org")
        XCTAssertEqual(link.confirmationParameters?.displayString, "#room:matrix.org")
    }
    ...
    private func checkLinkIn(attributedString: AttributedString?, expectedLink: String, expectedRuns: Int) {
        ...
        for run in attributedString.runs where run.link != nil {
            // Use effectiveURL to handle external links that are transformed for confirmation
            XCTAssertEqual(run.link?.effectiveURL.absoluteString, expectedLink)
            return
        }
