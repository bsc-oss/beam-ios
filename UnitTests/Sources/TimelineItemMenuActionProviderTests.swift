...
// PG_CHANGED
@MainActor
class TimelineItemMenuActionProviderTests: XCTestCase {
    ...
    func testTranslateActionShownWhenEnabled() {
        ...
        XCTAssertTrue(actions!.actions.contains(.translate),
                      "Translate action should appear when isTranslateEnabled is true")
    }
    
    func testTranslateActionHiddenWhenDisabled() {
        let item = makeTextItem()
        ...
        XCTAssertNotNil(actions)
        XCTAssertFalse(actions!.actions.contains(.translate),
                       "Translate action should not appear when isTranslateEnabled is false")
    }
    
    func testTranslateActionNotShownForNonCopyableItems() {
    ...
    func testCopyPermalinkActionShownWhenEnabled() {
        let item = makeTextItem()
        ...
        XCTAssertNotNil(actions)
        XCTAssertTrue(actions!.actions.contains(.copyPermalink),
                      "CopyPermalink action should appear when isCopyPermalinkEnabled is true")
    }
    
    func testCopyPermalinkActionHiddenWhenDisabled() {
        let item = makeTextItem()
    ...
    func testViewSourceActionShownWhenEnabled() {
        ...
        XCTAssertNotNil(actions)
        XCTAssertTrue(actions!.actions.contains(.viewSource),
                      "ViewSource action should appear when isViewSourceEnabled is true")
    }
    
    func testViewSourceActionHiddenWhenDisabled() {
        let item = makeTextItem()
    ...
    func testReportActionShownWhenEnabled() {
        ...
        XCTAssertNotNil(actions)
        XCTAssertTrue(actions!.secondaryActions.contains(.report),
                      "Report action should appear when isReportEnabled is true")
    }
    
    func testReportActionHiddenWhenDisabled() {
        let item = makeTextItem()
        ...
        XCTAssertNotNil(actions)
        XCTAssertFalse(actions!.secondaryActions.contains(.report),
                       "Report action should not appear when isReportEnabled is false")
    }
    
    func testReportActionNotShownForOutgoingItems() {
    ...
    func testEncryptedItemCopyPermalinkShownWhenEnabled() {
    ...
    func testEncryptedItemCopyPermalinkHiddenWhenDisabled() {
        let item = makeEncryptedItem()
        let provider = makeProvider(item: item, isCopyPermalinkEnabled: false)
    ...
    func testEncryptedItemViewSourceShownWhenEnabled() {
        let item = makeEncryptedItem()
        let provider = makeProvider(item: item, isViewSourceEnabled: true)
    ...
    func testEncryptedItemShowsBothActionsWhenBothEnabled() {
        let item = makeEncryptedItem()
